...
const { PORT, CONNECTION_URL,SENDER_EMAIL, EMAIL_PASSWORD, AWS_ACCESS_KEY, AWS_SECRET_ACCESS_KEY, AWS_BUCKET_NAME, AWS_REGION, FRONTEND_URL, API_KEY, JWT_SECRET } = process.env;
